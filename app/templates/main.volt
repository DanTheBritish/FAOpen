...
<div id="furaffinity">
    ...
    <nav id="ddmenu" class="block-menu-top">
        ...
        <div class="hideondesktop floatleft" style="font-size:24px;padding-top:7px"><a href="{{ url.get('') }}"><strong>Fur Affinity</strong></a></div>
        ...
        <ul>
            ...
            <li class="lileft dropdown" role="presentation">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a href="{{ url.get('journals/fender') }}">Fur Affinity News</a></li>
                    ...
                    <li><a href="http://help.furaffinity.net/article/AA-00210/7/Advertising.html">Advertising</a></li>

                    <li class="dropdown-header">Support</li>
                    <li><a href="{{ url.get('staff') }}">Fur Affinity Staff</a></li>
                    <li><a href="http://help.furaffinity.net">Help & FAQ</a></li>

                    <li class="dropdown-header">Rules & Policies</li>
                    <li><a href="http://help.furaffinity.net/article/AA-00203/8/Terms-of-Service-TOS.html">Terms of Service</a></li>
                    <li><a href="http://help.furaffinity.net/article/AA-01065/0/Code-of-Conduct-COC.html">Code of Conduct</a></li>
                    <li><a href="http://help.furaffinity.net/article/AA-00205/8/Acceptable-Upload-Policy-AUP.html">Upload Policy</a></li>
                </ul>
            </li>
    ...
    <div id="footer" class="bg5">
        ...
        <div class="p5 borderbot fontsize12">
            ...
            <span class="hideonmobile">
                <a href="http://help.furaffinity.net/article/AA-00210/7/Advertising.html">Advertising</a> |
