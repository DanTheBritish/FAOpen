...
{% block content %}
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            ...
            Dealing with a problem user? Having site issues or technical issues? We're here to help! From the Trouble Ticket page you can reach out to the Fur Affinity staff to report problems and get assistance with the site.
        </div>
