...
$config = array(
    ...
    'base_url'          => (FA_IS_SECURE ? 'https://' : 'http://').'furaffinity.net',

    // Path the cookie should use.
    'cookie_domain'     => '.furaffinity.net',
    ...
    // TODO: No API yet!
    // 'api_url'           => (FA_IS_SECURE ? 'https://' : 'http://').'api.furaffinity.net',
    ...
    'mail'              => array(
        ...
        'from_addr'         => 'noreply@furaffinity.net',
        'from_name'         => 'Fur Affinity',
        'use_smtp'          => true,
    ),
